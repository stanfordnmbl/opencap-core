...
sessionName = 'S1003'
cam2Use = ['Cam' + str(i) for i in [2,3,4]]
markerDataFolderNameSuffix = '3-cameras-234'
...
trialTypes = ['JOG','CROSS','SLHOP','TRIPLE']
trialNames = [tName for tName in trialNames if any(tType in tName for tType in trialTypes)]
