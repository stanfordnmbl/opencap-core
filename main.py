...
def main(sessionName, trialName, trial_id, camerasToUse=['all'],
    ...
    for c_idx, camerasToUse in enumerate(camerasToUses):
        for filtFreq in filters:
            ...
            filtFreqs = {'gait':filtFreq, 'default':filtFreq} # defaults to framerate/2
            ...
            if runPoseDetection:
                ...
                elif camerasToUse[0] == '2-cameras':            
                    if sessionName == '34cd32a0-2398-4e56-a4dc-879fb331e12d':
                        cameras2Use_t = ['Cam1', 'Cam2']
                    elif sessionName == '89e1063c-7ac6-458a-8416-d347c794a356':
                        cameras2Use_t = ['Cam0', 'Cam2']
                    elif sessionName == 'a269984f-0a9e-4d6f-b88c-8eef9e462027':
                        cameras2Use_t = ['Cam1', 'Cam2']
                    elif sessionName == 'a52cce9e-52db-4a42-8c5a-ef2ee2ca5dc0':
                        cameras2Use_t = ['Cam0', 'Cam2']
                    elif sessionName == '59b912fb-f5e2-42d8-a18e-331a2166e3f8':
                        cameras2Use_t = ['Cam0', 'Cam2']
                    elif sessionName == '3b7fbb9a-1083-497f-8de3-6b2d5e1d30c3':
                        cameras2Use_t = ['Cam0', 'Cam2']
                    elif sessionName == '6a8ebc43-9976-4f6a-9e1b-ba88a138915c':
                        cameras2Use_t = ['Cam0', 'Cam2']
                    elif sessionName == 'bc82fdc7-b342-4b07-89ab-c9fdd6d8966f':
                        cameras2Use_t = ['Cam0', 'Cam1']
                    elif sessionName == '1a39d188-6b7c-42c4-b7d7-d821656ae257':
                        cameras2Use_t = ['Cam1', 'Cam2']
                    elif sessionName == '059b2b0d-8d83-4cde-b856-fde0d031be21':
                        cameras2Use_t = ['Cam1', 'Cam2']
                else:            
                    # TODO
            ...
            if scaleModel and calibrationOptions is not None and alternateExtrinsics is None:
                # Only select relevant cameras from calibrationOptions
                cams_t = list(calibrationOptions.keys())
                for cam in cams_t:
                    if cam not in cameras2Use_t:
                        calibrationOptions.pop(cam)
